  <div id="content">
    <div class="container">
      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          <div class="panel-body">
           <div style="font-size:56px;text-align:center !important;" >              
             <span class="zicon-css3 color-wordpress"></span><span class="zicon-html5 color-soundcloud"></span><span class="zicon-code"></span>
           </div>
           <h2  style="margin-top: 5px;text-align:center;">Packed with features</h2>
           <p>ModernERS is easily customized throught an XML configuration document so you can showcase your brand in the event.</p>
